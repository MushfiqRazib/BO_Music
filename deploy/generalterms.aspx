<%@ page language="C#" masterpagefile="~/MainLayOut.master" autoeventwireup="true" inherits="generalterms, App_Web_generalterms.aspx.cdcab7d2" title="General Terms" theme="ThemeOne" %>
<%@ MasterType VirtualPath="~/MainLayOut.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlace" Runat="Server">
<div class="content-header">
        <div class="content-header-container">
            <asp:Label Text="Terms of use" id="lblTerms" runat="server">
                </asp:Label>
        </div>
    </div>
    
    <div style="margin:10px">
<asp:Label style="color:#2F2F2F;" ID="lblGenTerm" runat="server" Text="Label"></asp:Label>
</div>
