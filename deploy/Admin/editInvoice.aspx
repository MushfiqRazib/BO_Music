<%@ page language="C#" culture="nl-NL" autoeventwireup="true" inherits="Admin_editInvoice, App_Web_editinvoice.aspx.fdf7a39c" title="Edit Invoice" validaterequest="false" theme="ThemeOne" %>
...
<body class="adminbody">
    ...
    <div>
        <table cellpadding="0" cellspacing="0" border="0" class="contentArea">
            ...
            <tr>
                <td>
                    <table cellpadding="2" cellspacing="0" border="0" width="882" style="background-color: #DEDEDE;">
                        <tr>
                        ...
                        <tr>
                            <td width="50%" align="left" valign="top" >
                                <table cellpadding="2" cellspacing="0" border="0">
                                    <tr>
                                        <td valign="top">
                                            <asp:Label ID="lblInvoiceNo" runat="server" Text="Invoice#" Font-Bold="true" ForeColor="red"
                                                ></asp:Label>
                                        </td>
                                        <td align="left" valign="top">
                                            <asp:Label ID="lblInvoiceNoValue" runat="server" Font-Bold="true" ForeColor="red"
                                                ></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table cellpadding="2" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <input style="height: 20px" type="button" value=".." onclick="displayDatePicker('txtInvoiceDate');" /><br />
