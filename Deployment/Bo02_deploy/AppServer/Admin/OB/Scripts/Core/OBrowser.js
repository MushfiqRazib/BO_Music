...
var OBCore = function(showTabPanel) 
{
    ...
    this.FIXED_FIELD_SIZE_LIST = { '#': 20, ' ': 25, '': 25, 'Nr': 55, 'ADD': 25, 'EDIT': 30, 'PRINT':30, 'DELETE': 25, 'RECEIVE':30, 'ZOOM': 25, 'DETAIL': 30, 'BASKET': 25, 'THEME_COLOR':23, 'GROUP2FILTER':25,'EXPANDCOLLAPSE':25,'MULTISELECT':25};
