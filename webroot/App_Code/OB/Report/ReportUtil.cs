...
public class ReportUtil
{
    ...
    public ReportProperties GetReportProperties(string sql,string reportCode, Dictionary<string, string> dicparameters, EPageSize pageSize, EPaperFormat paperFormat, string pdfFilePath) // column width must be given as parameter for each field
    {
